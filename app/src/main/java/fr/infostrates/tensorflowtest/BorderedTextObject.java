...
public class BorderedTextObject {
   ...
   */
  public BorderedTextObject(final float textSize) {
   ...
   * @param textSize text size in pixels
   */
  public BorderedTextObject(final int interiorColor, final int exteriorColor, final float textSize) {
