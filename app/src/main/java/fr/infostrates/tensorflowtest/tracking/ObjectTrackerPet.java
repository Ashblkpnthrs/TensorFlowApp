...
import fr.infostrates.tensorflowtest.env.Size;
...
public class ObjectTrackerPet {
    ...
    protected static ObjectTrackerPet instance;
    ...
    public static synchronized ObjectTrackerPet getInstance(
        ...
        if (instance == null) {
            instance = new ObjectTrackerPet(frameWidth, frameHeight, rowStride, alwaysTrack);
            instance.init();
        } else {
    ...
    public synchronized void nextFrame(
        ...
        if (downsampledTimestamp != timestamp) {
            ObjectTrackerPet.downsampleImageNative(
    ...
    public synchronized void release() {
        releaseMemoryNative();
        synchronized (ObjectTrackerPet.class) {
            instance = null;
        }
    }
    ...
    public class TrackedObject {
        ...
        TrackedObject(final RectF position, final long timestamp, final byte[] data) {
            ...
            synchronized (ObjectTrackerPet.this) {
        ...
        public float getCurrentCorrelation() {
            checkValidObject();
            return ObjectTrackerPet.this.getCurrentCorrelation(id);
        }
        ...
        private void checkValidObject() {
            ...
            } else if (ObjectTrackerPet.this != instance) {
