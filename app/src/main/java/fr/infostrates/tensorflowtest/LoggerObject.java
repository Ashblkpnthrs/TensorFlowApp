...
public final class LoggerObject {
  ...
  static {
    ...
    IGNORED_CLASS_NAMES.add(LoggerObject.class.getCanonicalName());
  }
   ...
   */
  public LoggerObject(final String messagePrefix) {
   ...
   *     being used
   */
  public LoggerObject(final String tag, final String messagePrefix) {
    this.tag = tag;
  ...
  /** Creates a Logger using the caller's class name as the message prefix. */
  public LoggerObject(final int minLogLevel) {
    this(DEFAULT_TAG, null);
  ...
  private static String getCallerSimpleName() {
    ...
    return LoggerObject.class.getSimpleName();
  }
